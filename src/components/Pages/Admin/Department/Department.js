            ...
            <div className="col-12">
                <div className='row'>
                    <div className='col-lg-3'>
                        <Link className='btn btn-outline-secondary' to={"/department/add"}>Add New</Link>
                                            ...
                                            return (
                                                <tr key={i}>
                                                    ...
                                                    <td className="align-middle">
                                                        <Link to={`/department/update/${e.departmentId}`} className='btn btn-outline-success rounded-0'>Update</Link>
                                                        <button onClick={() => handleDelete(e.departmentId)} className='btn btn-outline-danger rounded-0'>Delete</button>
                                                    </td>
                                                </tr>
                                            )
                                        })
